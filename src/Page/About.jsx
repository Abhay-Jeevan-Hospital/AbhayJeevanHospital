...
export default function About() {
  return (
    <>
      <Helmet>
        <title>
          About Abhay Jeevan Hospital | Best Multispeciality Hospital in Jhunsi, Prayagraj
        </title>

        <meta
          name="description"
          content="Learn about Abhay Jeevan Hospital, a trusted multispeciality hospital in Jhunsi, Prayagraj. We are committed to providing quality healthcare with experienced doctors, modern medical facilities, advanced treatments, and compassionate patient care."
        />

        <meta
          name="keywords"
          content="About Abhay Jeevan Hospital, Abhay Jeevan Hospital Prayagraj, Hospital in Jhunsi, Best Multispeciality Hospital Prayagraj, Healthcare in Prayagraj"
        />
        ...
        <meta
          property="og:title"
          content="About Abhay Jeevan Hospital | Best Hospital in Prayagraj"
        />

        <meta
          property="og:description"
          content="Know more about Abhay Jeevan Hospital, our mission, experienced medical team, modern facilities, and commitment to quality healthcare in Jhunsi, Prayagraj."
        />
        ...
        <meta
          name="twitter:title"
          content="About Abhay Jeevan Hospital"
        />
        <meta
          name="twitter:description"
          content="Discover Abhay Jeevan Hospital's mission, values, expert doctors, and advanced healthcare services in Jhunsi, Prayagraj."
        />
        <meta
          name="twitter:image"
          content="https://yourdomain.com/og-image.jpg"
              ...
              {timeline.map((item, i) => {
                ...
                return (
                  <Reveal key={i} delay={i * 80}>
                    <div
                      className={`relative flex items-start gap-6 mb-12 md:mb-10 ${isLeft ? "md:flex-row" : "md:flex-row-reverse"
                        }`}
                    >
                      {/* Dot */}
                      <div
